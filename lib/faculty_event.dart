    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => FacultyInput()),
          );
        },
        backgroundColor: Color(0xFF41C9E2),
...
class EventCard extends StatefulWidget {
  ...
  final String imageUrl; // Change imagePath to imageUrl
  final String url;

  const EventCard({
    required this.title,
    required this.description,
    required this.imageUrl, // Change imagePath to imageUrl
    required this.url,
    Key? key,
  }) : super(key: key);
      ...
      child: Material(
        ...
        child: Card(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image.network(
                widget.imageUrl, // Use imageUrl instead of imagePath
                height: 180,
